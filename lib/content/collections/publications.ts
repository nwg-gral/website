...
export const publications = createCollection({
	name: "publications",
	directory: "./content/de/publications/",
	include: ["*/index.mdx"],
	read(item) {
		return reader.collections["de:publications"].readOrThrow(item.id, { resolveLinkedFiles: true });
	},

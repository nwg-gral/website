...
export const cooperationPartners = createCollection({
	name: "cooperation-partners",
	directory: "./content/de/cooperation-partners/",
	include: ["*/index.mdx"],
	read(item) {
		return reader.collections["de:cooperation-partners"].readOrThrow(item.id, {

...
export const internationalAdvisoryBoardMembers = createCollection({
	name: "international-advisory-board-members",
	directory: "./content/de/international-advisory-board-members/",
	include: ["*/index.mdx"],
	read(item) {
		return reader.collections["de:international-advisory-board-members"].readOrThrow(item.id, {

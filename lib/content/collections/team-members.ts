...
export const teamMembers = createCollection({
	name: "team-members",
	directory: "./content/de/team-members/",
	include: ["*/index.mdx"],
	read(item) {
		return reader.collections["de:team-members"].readOrThrow(item.id, { resolveLinkedFiles: true });
	},

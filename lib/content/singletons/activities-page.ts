...
function createActivitiesPageCollection<TLocale extends IntlLocale>(locale: TLocale) {
	const language = getIntlLanguage(locale);
	const collection = withI18nPrefix("activities-page", language);
	...
	return createCollection({
		name: collection,
		directory: `./content/${language}/activities-page/`,
		include: ["index.mdx"],
		read() {
...
export const activitiesPage = {
	de: createActivitiesPageCollection("de-DE"),
	en: createActivitiesPageCollection("en-GB"),
};

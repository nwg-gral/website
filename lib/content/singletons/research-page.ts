...
function createResearchPageCollection<TLocale extends IntlLocale>(locale: TLocale) {
	const language = getIntlLanguage(locale);
	const collection = withI18nPrefix("research-page", language);
	...
	return createCollection({
		name: collection,
		directory: `./content/${language}/research-page/`,
		include: ["index.mdx"],
		read() {
...
export const researchPage = {
	de: createResearchPageCollection("de-DE"),
	en: createResearchPageCollection("en-GB"),
};

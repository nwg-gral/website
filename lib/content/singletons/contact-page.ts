...
export const contactPage = createCollection({
	name: "contact-page",
	directory: "./content/de/contact-page/",
	include: ["index.mdx"],
	read() {
		return reader.singletons["de:contact-page"].readOrThrow({ resolveLinkedFiles: true });
	},
